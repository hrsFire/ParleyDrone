...
public class Translation {
	...
	public ArrayList<AntonymSynonymPair> antonymPair = new ArrayList<AntonymSynonymPair>();
	public ArrayList<AntonymSynonymPair> synonymPair = new ArrayList<AntonymSynonymPair>();
